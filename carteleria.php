<?php
// carteleria.php - IMPRESIÓN DE ETIQUETAS
session_start();
// 1. CONEXIÓN
...
$rol = $_SESSION['rol'] ?? 3;
if (!in_array('imprimir_carteles', $permisos) && $rol > 2) {
    ...
    <div class="container mt-4">
        <div class="card shadow-sm mb-4 no-print border-0">
            <div class="card-body">
                ...
                <div class="form-text">Selecciona 'Imprimir' y marca solo las páginas que necesites.</div>
            </div>
        </div>

        <div class="row" id="areaImpresion">
            <?php foreach($productos as $p): ?>
            <div class="col-md-4 col-6"> <div class="etiqueta position-relative">
