<?php
// ticket.php - DISEÑO PARA IMPRESORAS TÉRMICAS (58mm/80mm)
session_start();
...
<body onload="window.print()">
    <div class="ticket">
        <div class="centrado">
            <h3 class="negrita"><?php echo strtoupper($conf['nombre_negocio']); ?></h3>
        ...
        <div class="derecha totales">
            ...
            <p class="negrita" style="font-size: 16px;">TOTAL: $<?php echo number_format($venta['total'], 2); ?></p>
